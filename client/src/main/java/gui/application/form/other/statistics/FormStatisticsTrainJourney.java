...
import dao.TrainJourneyRankingDAO;
...
public class FormStatisticsTrainJourney extends JPanel {
	...
	private TrainJourneyRankingDAO trainJourneyRankingDAO;

	public FormStatisticsTrainJourney(Employee employee) {
		trainJourneyRankingDAO = new TrainJourneyRankingDAO();
		...
		trainJourneyRankingList = trainJourneyRankingDAO.getTop10TrainJourneyRanking(LocalDate.now().getMonthValue(), LocalDate.now().getYear());
		// state
	...
	private void render() {
		...
		monthCombobox.addActionListener(e -> {
			...
			trainJourneyRankingList = trainJourneyRankingDAO.getTop10TrainJourneyRanking(selectedMonth, selectedYear);
			render();
		});
